...
const BRAND_PATHS: Partial<Record<SocialId, string>> = {
  ...
  medium:
    "M13.54 12a6.8 6.8 0 0 1-6.77 6.82A6.8 6.8 0 0 1 0 12a6.8 6.8 0 0 1 6.77-6.82A6.8 6.8 0 0 1 13.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42S20.96 8.46 20.96 12M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75C23.47 6.25 24 8.83 24 12z",
};

function CollectiveGlyph({ className }: { className: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
      <path
        d="M19.89 15.68A8.7 8.7 0 1 1 19.89 8.32"
        stroke="currentColor"
        strokeWidth="3.2"
        strokeLinecap="round"
      />
...
export function SocialIcon({
  ...
  if (logo) {
    return (
      <Image src={logo} alt={label ?? ""} width={24} height={24} unoptimized className={className} />
    );
  }

  if (id === "collective") return <CollectiveGlyph className={className} />;
